...
等待献浆员
 */
public class WaitingPlasmFragment extends Fragment {
    ...
    public static WaitingPlasmFragment newInstance(String param1, String param2) {
        WaitingPlasmFragment fragment = new WaitingPlasmFragment();
